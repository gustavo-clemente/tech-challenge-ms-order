...
class CheckoutOrderApplicationTest extends TestCase
{
    public function test_checkout_order_returns_correct_output(): void
    {
        $order = new Order(
        ...
        $orderOutput = app(CheckoutOrderApplication::class)->checkoutOrder($orderIdInput);
