...
class CancelOrderApplicationTest extends TestCase
{
    public function test_cancel_order_returns_correct_output(): void
    {
        $order = new Order(
        ...
        $orderOutput = app(CancelOrderApplication::class)->cancelOrder($orderIdInput);
